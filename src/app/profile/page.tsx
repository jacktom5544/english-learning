...
const teacherOptions = [
  ...
  { 
    value: 'reiko', 
    label: '玲子先生', 
    description: 'とある財閥の令嬢ながら英語の先生になったという珍しい先生。「ですわ」口調がトレードマーク。頭脳明晰、容姿端麗で一見接しにくいように感じるけど生徒想いの優しい先生。ただ酒癖があまり良くなく一緒に飲み会に行った同僚は「もう二度と玲子先生」とは飲み会に行きたくないって言ったとか言ってないとか・・・',
